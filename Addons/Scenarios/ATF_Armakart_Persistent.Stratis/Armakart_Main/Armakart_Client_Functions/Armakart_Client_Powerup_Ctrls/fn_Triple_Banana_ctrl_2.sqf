...
["Armakart", "MyKey", "Powerup Action", {
	...
	if (_obj isEqualTo []) then {
		[player, 2] remoteExec ["NJP_Server_Powerup_Fnc_Banana", 2];
...
while {Initial_hint isEqualTo _Initial_hint_local} do {
	hintsilent parseText "<t>Banana 2 Status:  </t><t color='#45f442'>Ready To Place</t><br/><br/><t>[Default Keybind: F]</t><br/><t>[Default Discard Keybind: C]</t>";
	uiSleep 10;
};