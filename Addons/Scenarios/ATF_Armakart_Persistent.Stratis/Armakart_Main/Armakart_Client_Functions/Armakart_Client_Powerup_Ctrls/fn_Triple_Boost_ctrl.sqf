...
["Armakart", "MyKey", "Powerup Action", {
	[player, 1] remoteExec ["NJP_Server_Powerup_Fnc_Boost", 2];
...
while {Initial_hint isEqualTo _Initial_hint_local} do {
	hintsilent parseText "<t color='#731717'>Triple Boost acquired!</t><br/><br/><t>Boost 1 Status:  </t><t color='#45f442'>Ready To Boost</t><br/><br/><t>The Triple Boost powerup will simply give you 3x Speed boosts, which you can trigger at your own volition.</t><br/><br/><t>[Default Keybind: F]</t><br/><t>[Default Discard Keybind: C]</t>";
	uiSleep 20;
};
