...
["Armakart", "MyKey", "Powerup Action", {
	...
	[_Search_Array, player] remoteExec ["NJP_Server_Powerup_Fnc_Lightning", 2];
...
while {Initial_hint isEqualTo _Initial_hint_local} do {
	hintsilent parseText "<t color='#04378f'>Lightning acquired!</t><br/><br/><t>Lightning Status:  </t><t color='#45f442'>Ready To Zap</t><br/><br/><t>The Lightning powerup will disable the kart of the person under your corsshairs for a short period of time.</t><br/><br/><t>[Default Keybind: F]</t><br/><t>[Default Discard Keybind: C]</t>";
	uiSleep 20;
};