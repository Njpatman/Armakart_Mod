...
["Armakart", "MyKey", "Powerup Action", {
	[player, 3] remoteExec ["NJP_Server_Powerup_Fnc_Boost", 2];
...
while {Initial_hint isEqualTo _Initial_hint_local} do {
	hintsilent parseText "<t>Boost 3 Status:  </t><t color='#45f442'>Ready To Boost</t><br/><br/><t>[Default Keybind: F]</t><br/><t>[Default Discard Keybind: C]</t>";
	uiSleep 20;
};