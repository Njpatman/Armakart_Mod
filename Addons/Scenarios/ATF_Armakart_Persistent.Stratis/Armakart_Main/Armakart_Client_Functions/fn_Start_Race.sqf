...
// Exit if spectator
if (Is_Spectator) exitWith {  // Check if player, even a host
...
Vehicle_Texture = getObjectTextures vehicle player;
Vehicle_Lights = isLightOn vehicle player;
...
systemChat "|Armakart System| : Race has begun. Player Reset will be available in 12.5 seconds!";
