...
private[ "_obj" ];
params[ "_compLocal", "_cfg", [ "_info", grpNull ] ]; //INFO is usually a group but is also used by triggers as a defered boolean flag
...
switch ( _dataType ) do {
	...
	case "Object" : {
		_obj = [ _cfg, _info, _compLocal ] call LARs_fnc_spawnObject;
